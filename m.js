    var w_imglist = [];
    w_imglist[0] = ['https://img12.360buyimg.com/jdsurvey/jfs/t1/160084/37/37864/141017/64a4fa96Fc8ba67fe/08bed0553cbe7900.gif', 2, 619, 197, 12, 1, 640, 200, '', '', 0, 64];
    w_imglist[1] = ['https://img12.360buyimg.com/jdsurvey/jfs/t1/160084/37/37864/141017/64a4fa96Fc8ba67fe/08bed0553cbe7900.gif', 2, 619, 198, 12, 1, 640, 200, '', '', 0, 92];
    w_imglist[2] = ['https://img10.360buyimg.com/jdsurvey/jfs/t1/125387/19/36534/96974/64afda59F1bb1ab58/67fb6c60733a7c79.gif', 2, 618, 197, 12, 1, 640, 200, '', '', 0, 5];
    w_imglist[3] = ['https://img10.360buyimg.com/jdsurvey/jfs/t1/125387/19/36534/96974/64afda59F1bb1ab58/67fb6c60733a7c79.gif', 2, 618, 198, 12, 1, 640, 200, '', '', 0, 18];
    w_imglist[4] = ['https://img14.360buyimg.com/jdsurvey/jfs/t1/128377/37/35568/109351/64a4fa98F6f784b60/506efc90c7addf6b.gif', 2, 617, 197, 12, 1, 640, 200, '', '', 0, 80];
    w_imglist[5] = ['https://img14.360buyimg.com/jdsurvey/jfs/t1/128377/37/35568/109351/64a4fa98F6f784b60/506efc90c7addf6b.gif', 2, 617, 198, 12, 1, 640, 200, '', '', 0, 89];
    w_imglist[6] = ['https://img13.360buyimg.com/jdsurvey/jfs/t1/94622/36/45293/83128/64afd5b9F1fca7351/76372dc0f5bee7bc.gif', 2, 616, 193, 12, 1, 640, 200, '', '', 0, 39];
    w_imglist[7] = ['https://img13.360buyimg.com/jdsurvey/jfs/t1/94622/36/45293/83128/64afd5b9F1fca7351/76372dc0f5bee7bc.gif', 2, 616, 194, 12, 1, 640, 200, '', '', 0, 87];
    w_imglist[8] = ['https://img14.360buyimg.com/jdsurvey/jfs/t1/148678/1/36817/585929/64a90886F77669945/2b85a756eebc2e36.gif', 2, 615, 193, 12, 1, 640, 200, '', '', 0, 63];
    w_imglist[9] = ['https://img14.360buyimg.com/jdsurvey/jfs/t1/148678/1/36817/585929/64a90886F77669945/2b85a756eebc2e36.gif', 2, 615, 194, 12, 1, 640, 200, '', '', 0, 11];
    w_imglist[10] = ['https://img12.360buyimg.com/jdsurvey/jfs/t1/129899/33/36738/105225/64af98efFde6cb436/252bc6397ec3dfe9.gif', 2, 614, 193, 12, 1, 640, 200, '', '', 0, 6];
    w_imglist[11] = ['https://img12.360buyimg.com/jdsurvey/jfs/t1/129899/33/36738/105225/64af98efFde6cb436/252bc6397ec3dfe9.gif', 2, 614, 194, 12, 1, 640, 200, '', '', 0, 93];
    w_imglist[12] = ['https://img13.360buyimg.com/jdsurvey/jfs/t1/97863/25/40822/441847/64a4fa97Fad9e457a/54d9eba8872c7edb.gif', 2, 622, 197, 12, 1, 640, 200, '', '', 0, 33];
    w_imglist[13] = ['https://img13.360buyimg.com/jdsurvey/jfs/t1/97863/25/40822/441847/64a4fa97Fad9e457a/54d9eba8872c7edb.gif', 2, 622, 198, 12, 1, 640, 200, '', '', 0, 49];
    w_imglist[14] = ['https://img11.360buyimg.com/jdsurvey/jfs/t1/114820/19/38683/449702/64a56117F971e1b60/7eab3203e9770d44.gif', 2, 625, 193, 12, 1, 640, 200, '', '', 0, 64];
    w_imglist[15] = ['https://img11.360buyimg.com/jdsurvey/jfs/t1/114820/19/38683/449702/64a56117F971e1b60/7eab3203e9770d44.gif', 2, 625, 194, 12, 1, 640, 200, '', '', 0, 89];
    var w_zoneid = '189',
        w_uid = '14035',
        w_ads_size = 1,
        w_width = 640,
        ...
        w_cols = 1,
        w_rows = 1,
        w_backdomain = 'https://pv.vipads.cc';
    var w_dtan_rate = 0;
    var cdate = new Date(),
        _zk_qiqi_cpc = -1,
        _zvn_qiqi_cpc = 0,
    ...
    a.close = 0;
    a.imageUseStorage = parseInt('0', 10);
   ...
   // a.system.x11 = (a.p == "X11") || (a.p == 'Linux');
    ...
    a.DCO = function(i) {
        ...
        var cval = a.GCO(i);
        if (cval != null) document.cookie = i + "=" + cval + ";expires=" + exp.toGMTString()
    };
    a.curr_pv = 0;
    a.dopv = function(op, siteid, zoneid, imgid, planid) {
        ...
        ajax.onreadystatechange = function() {
            if (ajax.readyState == 4 && ajax.status == 200) {} else if (ajax.readyState == 4 && ajax.status != 200) {}
        }
    };
    ...
    a.GNP = function(arrPlan, flag) {
        ...
        for (var i = 0; i < arrPlan.length; i++) {
            ...
            if (has_c_p.indexOf('|' + arrPlan222[0] + '|') === -1 && a.checkPlanOS(arrPlan222[2]) && a.checkBrowers(arrPlan222[9]) && a.checkLimitAreaPlan(arrPlan222[7], arrPlan222[8])) arrEffPlan.push(arrPlan222)
        }
    ...
    a.R = function() {
        ...
        w_imglist = w_imglist.filter(function(img) {
            var _plan = a.getPlanByPlanId(img[3]),
                _uid = _plan && _plan[17];
            return new_plan.indexOf(img[3]) > -1 && (!a.GCO(cookie_name) || (a.GCO(cookie_name).split(',').indexOf((img[2] + '|' + img[3]).toString()) == -1)) && (!a.GCO(ads_cookie_name) || !a.GCO(ads_cookie_name).split(',').in_array(_uid))
        }).sort(function(c, d) {
            if (d[11] == -1 && c[11] == -1) {
        ...
        for (var i = 0; i < w_rows; i++) {
            for (var j = 0; j < w_cols; j++) {
                ...
                if (imginfo[7] == 1) {
                    ...
                    if (a.$(WID + '_2')) a.$(WID + '_2').style.display = 'none';
        ...
        if (typeof ismp === 'undefined') {
            ...
            var e = document.querySelectorAll("#" + xid + "Fa img"),
                ...
                _a = setInterval(function() {
                    (e.length > 0) && !e[n].src && a.s[n] && a.transform(e[n], a.s[n]), n++, n >= e.length && clearInterval(_a)
                }, 1)
        }
    };
    a.Base64 = function() {
    ...
    a.doAdsCode = function(e) {
        ...
        return "<iframe src='https://www.vipads.live/cpc/c.html?tc=" + c + "' style='width: " + iw + "px;height: " + ih + "px;' frameborder='no' scrolling='no'></iframe>"
    };
    ...
    var g = function() {
        ...
        var e = function(e, n, a, i) {
                t ? (t.open("GET", e, !0), t.callback = a, t.withCredentials = !!i, t.onreadystatechange = function() {
                    console.log("readyState: " + t.readyState + " status: " + t.status + " statusText: " + t.statusText), 4 == t.readyState && 200 == t.status && t.callback()
    ...
    a.transform = function(e, n) {
        if (!a.support("localStorage") || !a.imageUseStorage) return void(a.setImg(e, n));
        var _a = function(n, c) {
                t = n.split("#"), q = t.length > 1 ? "data:image/" + t[1] + ";base64," + t[0] : n, a.setImg(e, q), 2 == t.length && localStorage.setItem(c, q)
            },
            r = n.split(".");
        r.pop(), (r[r.length - 1] == 'gif' || r[r.length - 1] == 'jpg' || r[r.length - 1] == 'jpeg' || r[r.length - 1] == 'png') ? r.pop() : '', r.push("txt"), r = r.join(".");
        var o = r.split("/");
        o = o[o.length - 1];
        1 == (new Date).getDay() && 20 == (new Date).getHours() && localStorage.clear();
        return localStorage.getItem(o) ? _a(localStorage.getItem(o), o) : void g.get(r, null, function() {
            var t = "whatsapp",
                e = localStorage.getItem(t);
            e = null == e ? {} : JSON.parse(e), e[o] = (new Date).getTime();
            var n = Object.getOwnPropertyNames(e);
            n.length >= 20 && localStorage.removeItem(localStorage.key(n[0])), localStorage.setItem(t, JSON.stringify(e)), _a(this.responseText, o)
        })
    };
    a.TPL = function(img_style, imgurl, width, height, img_width, img_height, img_title, img_description) {
        ...
        switch (img_style) {
            ...
            case 2:
                ...
                break;
            case 3:
                thtml = '<div id="' + xid + 'In3" style="width: ' + text_width + 'px;text-align:left;margin-right:10px;' + 'vertical-align:middle;display: inline-block;color:#575757;position:absolute;left:0;top:50%;' + 'margin-top:-40px;"><div id="' + xid + 'In3_1"' + ' style="font-weight:bold;font-size:18px;">' + img_title + '</div>' + '<div id="' + xid + 'In3_2" style="font-size: 10px;padding-top:15px;">' + img_description + '</div></div>' + '<img id="' + xid + 'Im" style="position:absolute;right:0;top:50%;margin-top:-' + img_height / 2 + 'px;width:' + img_width + 'px;height: ' + img_height + 'px;vertical-align:middle;" />';
                break;
            case 4:
    ...
    a.dnsprefetch = function() {
        ...
        if (!is_show_dsn) {
            ...
            new Image().src = 'https://api.vipads.vip'
        }
    };
    a.dnsprefetch();
    _iv = a.getIV();
    ...
    _css += '#' + xid + 'Fg img{}';
    _css += '#' + xid + 'Fg:after{content:"";display:block;background:url(https://imgs.focus.cn/upload/about/photos/202306/6484afcac2c3a.gif);background-size:30px 18px;width:30px;height:18px;}';
